...
class LabCertified extends StatefulWidget {
  ...
  LabCertified(this.stockType, this.HUID, this.ptype, this.collection, this.col, this.cat, this.mwCollection, this.scat, this.cultNm, this.cultId, this.dgno, this.geniid,this.GrossWeight,this.NetWeight,this.WasteWeight,this.purityID,this.purityDT,this.purity,this.matcol,this.mtid,this.Mat_Code , {Key? key}) : super(key: key);

  @override
  _LabCertifiedState createState() => _LabCertifiedState(stockType, HUID, ptype, collection, col, cat, mwCollection, scat, cultNm, cultId, dgno, geniid,GrossWeight,NetWeight,WasteWeight,purityID,purityDT,purity,matcol,mtid,Mat_Code);
}
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) => InkWell(
                                onTap: () => {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => MFGType(stockType, HUID, ptype, collection, col, cat, mwCollection, scat, cultNm, cultId, dgno, geniid,GrossWeight,NetWeight,WasteWeight,purityID,purityDT,purity,collectionTypeList[index].certId.toString(),matcol,mtid,Mat_Code)),
                                  ),
                                },
                                child: Card(
                                    elevation: 10,
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            collectionTypeList[index].certiName.toString(),
                                ...
                                child: Padding(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => MFGType(stockType, HUID, ptype, collection, col, cat, mwCollection, scat, cultNm, cultId, dgno, geniid,GrossWeight,NetWeight,WasteWeight,purityID,purityDT,purity,"",matcol,mtid,Mat_Code)),
                                      );
                                    },
                                  ),
                                ),
