                              ...
                              child: Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          collectionTypeList[index].materialName.toString(),
                                ...
                                child: Padding(
                                  ...
                                  child: Center(
                                    child: RaisedButton(
                                      ...
                                      child: const Text(
                                        'SKIP MATERIAL SPECIFICATION',
                                        textAlign: TextAlign.center,
                                      ),
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => UpLoadImage(stockType, HUID, ptype, collection, col, cat, mwCollection, scat, cultNm, cultId, "", "", preferences!.getString(mSharedPreference().jobNumber).toString())),
                                        );
                                      },
                                    ),
                                  ),
